...
![Screenshot della pagina principale freeCodeCamp News Authors con le prime 8 card degli autori caricate](./assets/fcc-news-authors-page-1.webp)
![Screenshot finale della pagina mostrando il caricamento completo degli autori](./assets/fcc-news-authors-page-2.webp)
