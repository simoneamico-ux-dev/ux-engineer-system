...
![Interfaccia principale del gioco dei dadi che mostra le regole di gioco e 5 dadi](./assets/dice-game-1.webp)
![Interfaccia di gioco che mostra una scala minore con un punteggio di 30 punti](./assets/dice-game-2.webp)
![Pannello della cronologia dei punteggi che mostra un punteggio totale di 30, ottenuto da una scala minore del valore di 30 punti](./assets/dice-game-3.webp)
![Schermata di fine partita che mostra il punteggio finale](./assets/dice-game-4.webp)
