...
![Anteprima del progetto Todo App – screenshot della pagina di aggiunta attività](./assets/todo-app-1.webp)
![Anteprima del progetto Todo App – screenshot di esempio della pagina principale](./assets/todo-app-2.webp)
