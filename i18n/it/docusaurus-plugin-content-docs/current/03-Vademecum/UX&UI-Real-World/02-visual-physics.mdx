...
**L'Analogia:** Leggere un testo con interlinea stretta è come cercare di camminare in una folla dove tutti ti stanno appiccicati: soffocante. Leggere con interlinea troppo larga è come saltare tra le pietre di un fiume: devi fare troppa fatica per arrivare all'altra sponda.
