...
![Main menu showing Code Warrior title with Start Game button](./assets/platformer-game-1.webp)
![Platformer game started with player character on platforms](./assets/platformer-game-2.webp)
![Player character near yellow intermediate checkpoint](./assets/platformer-game-3.webp)
![Victory screen showing congratulations for reaching final checkpoint](./assets/platformer-game-4.webp)
