...
![Screenshot of the freeCodeCamp News Authors main page displaying the initial 8 author cards](./assets/fcc-news-authors-page-1.webp)
![Final page screenshot showing all authors fully loaded](./assets/fcc-news-authors-page-2.webp)
