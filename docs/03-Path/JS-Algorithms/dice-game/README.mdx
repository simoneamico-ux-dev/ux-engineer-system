...
![Dice game main interface showing game rules and 5 dice](./assets/dice-game-1.webp)
![Game interface showing a small straight pattern with score of 30 points](./assets/dice-game-2.webp)
![Score history panel showing total score of 30 from one small straight worth 30 points](./assets/dice-game-3.webp)
![Game over screen displaying final score](./assets/dice-game-4.webp)
