...
```html
<!DOCTYPE html>
<!-- 🎯 HTML5 DECLARATION: "Welcome to interactive button design!" -->
<!-- This document follows modern semantic HTML principles for accessibility and interaction! 🖱️ -->

<html lang="en">
<!-- 🌍 LANGUAGE SETTING: English as the document language -->
<!-- Proper language declaration helps screen readers use correct pronunciation -->

<head>
    <!-- 🧠 THE COMMAND CENTER: Where we prepare our interactive button -->
    <!-- Like the blueprint room where we design the perfect button mechanics! -->
    
    <title>Interactive Button with Loading State</title>
    <!-- 📑 PAGE TITLE: Describes what this component demonstrates -->
    ...
    <style> 
      /* 🎨 ===== CSS STYLES: The Button's Appearance and Behavior ===== */
      
      /* 🏗️ ===== DESIGN SYSTEM: The "Physical Laws" of Our UI ===== */
      
      :root {
          /* 🎨 COLORS: The palette of our interactive element */
          --primary-color: #ffd500;
          /* 🟡 YELLOW PRIMARY: Bright, attention-grabbing button color */
          /* Yellow suggests caution or attention - perfect for confirmation actions */
          
          --hover-color: #d5bb3b;
          /* 🟨 DARKER YELLOW: Shows interactive state on hover */
          /* Slightly darker to provide clear visual feedback when cursor hovers */
          
          --bg-body: #524236;
          /* 🟤 BROWN BACKGROUND: Creates contrast with the yellow button */
          /* Rich earth tone that makes the bright button stand out dramatically */
          
          --btn-text: #000000;
          /* ⚫ BLACK TEXT: Maximum readability on yellow background */
          /* High contrast ratio ensures text is legible for all users */
          
          /* 📐 SHAPES AND TYPOGRAPHY: Defining the button's form */
          --btn-radius: 14px;
          /* 🔄 ROUNDED CORNERS: Soft appearance, 14px radius */
          /* Not too round, not too square - a balanced, modern look */
          
          --btn-weight: 550;
          /* 🔤 SEMI-BOLD FONT: Custom weight for perfect visibility */
          /* 550 is between regular (400) and bold (700) - distinctive without shouting */
          
          /* 📦 PHYSICS: Shadow properties create a sense of depth */
          --shadow-rest: 0 8px 10px -1px rgba(0, 0, 0, 0.4);
          /* 🕳️ RESTING SHADOW: Deeper shadow when button is not pressed */
          /* 8px vertical offset creates a floating effect above the surface */
          
          --shadow-active: 0 1px 2px 0 rgba(0, 0, 0, 0.05);
          /* 🕳️ ACTIVE SHADOW: Minimal shadow when button is pressed */
          /* 1px vertical offset mimics the button being pressed against the surface */
      }
      
      /* 📄 ===== BODY STYLING: Canvas for Our Button ===== */
      
      body {
          background-color: var(--bg-body);
          /* 🟤 BACKGROUND: Brown color from our design system */
          
          /* 📏 PERFECT CENTERING SETUP: Places button in middle of viewport */
          margin: 0;
          /* 🚫 NO MARGINS: Removes default spacing */
          ...
          display: grid;
          /* 📊 GRID DISPLAY: Modern layout system */
          /* Grid provides the simplest way to center content perfectly */
          
          place-items: center;
          /* ⚖️ PERFECT CENTERING: Centers content horizontally and vertically */
          /* This is the modern approach to centering - much cleaner than old methods */
      }
      
      /* 🔘 ===== BUTTON BASE: The Foundation of Our Interactive Element ===== */
      
      .norman-btn {
          /* 📊 GRID STACKING TECHNIQUE: For perfect alignment of text and loader */
          display: inline-grid;
          /* 📊 INLINE-GRID: Behaves like inline element but with grid powers */
          /* Allows us to stack text and loader precisely in the same space */
          
          place-items: center;
          /* ⚖️ CENTER ALIGNMENT: Centers stacked items perfectly */
          /* Both horizontally and vertically within the button */
          
          grid-template-areas: "stack";
          /* 📍 NAMED GRID AREA: Creates a single cell named "stack" */
          /* This single area will hold both text and loader elements */
          
          position: relative;
          /* 📍 POSITIONING CONTEXT: Establishes positioning for child elements */
          
          padding: 0.75rem 1.5rem;
          /* 📏 INTERNAL SPACING: Comfortable space around the text */
          /* 0.75rem (12px) top/bottom, 1.5rem (24px) left/right */
          
          min-width: 160px;
          /* 📏 MINIMUM WIDTH: Ensures button doesn't collapse when text is hidden */
          ...
          border-radius: var(--btn-radius);
          /* 🔄 ROUNDED CORNERS: Using design system variable */
          
          background-color: var(--primary-color);
          /* 🟡 YELLOW FILL: Primary color from design system */
          
          color: var(--btn-text);
          /* ⚫ TEXT COLOR: Black from design system */
          
          font-weight: var(--btn-weight);
          /* 🔤 FONT WEIGHT: Semi-bold from design system */
          
          box-shadow: var(--shadow-rest);
          /* 🕳️ SHADOW EFFECT: Creates illusion of elevation */
          ...
          transition: all 0.1s ease;
          /* 🎭 SMOOTH CHANGES: Animates all property changes */
          /* 0.1s is fast enough to feel responsive but still show the transition */
          /* "ease" timing function mimics natural movement physics */
      }
      
      /* 📚 ===== STACKED ELEMENTS: Positioning Text and Loader ===== */
      
      .btn-text, .loader {
          grid-area: stack;
          /* 📍 SHARED GRID AREA: Both elements occupy the same space */
          /* This mathematical approach ensures perfect centering without absolute positioning */
          
          transition: opacity 0.2s ease;
          /* ✨ FADE EFFECT: Smooth transition between visible and hidden states */
          /* 0.2s provides a noticeable but quick fade effect */
      }
      
      /* 👆 ===== HOVER STATE: Button Appearance When Cursor Hovers ===== */
      
      .norman-btn:hover {
          background-color: var(--hover-color);
          /* 🟨 DARKER COLOR: Changes to hover color on mouseover */
          
          transform: translateY(-1px);
          /* ⬆️ SLIGHT LIFT: Button rises slightly toward cursor */
      ...
      /* 👇 ===== ACTIVE STATE: Button Appearance When Being Clicked ===== */
      
      .norman-btn:active {
          transform: translateY(2px);
          /* ⬇️ PRESS DOWN: Button moves down when clicked */
          /* 2px of movement creates the illusion of physical depression */
          
          box-shadow: var(--shadow-active);
          /* 🕳️ SMALLER SHADOW: Shadow reduces as button "moves closer" to surface */
          /* This completes the physical metaphor of a button being pressed */
      }
      
      
      /* ⏳ ===== LOADING STATE: Button Appearance During Processing ===== */
      
      .norman-btn.loading {
          cursor: wait;
          /* ⏳ WAIT CURSOR: Changes cursor to indicate processing */
          
          opacity: 0.8;
          /* 🔍 SLIGHT TRANSPARENCY: Visual feedback that button is in a special state */
          
          pointer-events: none;
          /* 🚫 DISABLE INTERACTIONS: Prevents additional clicks during processing */
          /* This constraint prevents users from "rage clicking" or double-submitting */
          
          /* ⬇️ VISUAL PERSISTENCE OF PRESSED STATE PHYSICS: */
          box-shadow: none;
          /* 🚫 NO SHADOW: Completely pressed against surface */
          
          transform: translateY(2px);
          /* ⬇️ PRESSED POSITION: Stays in the "down" position */
          
          background-color: var(--hover-color);
          /* 🟨 DARKER COLOR: Maintains the active color state */
          /* All these properties combine to show the button is "working" */
      }
      
      /* 🔄 ===== LOADER ANIMATION: The Spinning Indicator ===== */
      
      .loader {
          /* 👁️ VISIBILITY MANAGEMENT: Initially hidden but ready to appear */
          visibility: hidden;
          /* 🚫 HIDDEN INITIALLY: Not visible but still in DOM */
          
          opacity: 0;
          /* 🔍 FULLY TRANSPARENT: For smooth fade-in transition */
          
          width: 1rem;
          height: 1rem;
          /* 📏 LOADER SIZE: 16px square (1rem = 16px typically) */
          
          /* 💫 SPINNER DESIGN: Creates a circular loading indicator */
          border: 2px solid var(--btn-text);
          /* 🔘 CIRCLE OUTLINE: 2px border using text color for consistency */
          
          border-bottom-color: transparent;
          /* 🔍 TRANSPARENT SEGMENT: Creates the "incomplete circle" effect */
          /* This visual break in the circle is what creates the spinning illusion */
          
          border-radius: 50%;
          /* 🔄 PERFECT CIRCLE: 50% radius creates a circle from a square */
      ...
      /* 🔀 ===== STATE TRANSITIONS: Showing/Hiding Elements Based on State ===== */
      
      .norman-btn.loading .btn-text { 
          visibility: hidden;
          /* 🚫 HIDE TEXT: Makes text invisible during loading */
          
          opacity: 0;
          /* 🔍 FULLY TRANSPARENT: For smooth fade-out transition */
      }
      
      .norman-btn.loading .loader { 
          visibility: visible;
          /* 👁️ SHOW LOADER: Makes loader visible during loading */
          
          opacity: 1;
          /* 🔍 FULLY OPAQUE: For smooth fade-in transition */
      }
      
      /* 🔄 ===== KEYFRAME ANIMATION: Defines the Rotation Effect ===== */
      
      @keyframes rotation {
          0% { transform: rotate(0deg); }
          /* 🔄 START POSITION: Beginning of rotation cycle at 0 degrees */
          
          100% { transform: rotate(360deg); }
          /* 🔄 END POSITION: Complete 360-degree revolution */
...
<body>
    <!-- 📦 ===== THE BODY: Where Our Interactive Button Lives! ===== -->
    
    <div class="button-container">
        <!-- 📦 BUTTON CONTAINER: Wrapper for positioning and potential styling -->
        <!-- This container could be used for additional positioning or decorations -->
        
        <button id="action-btn" class="norman-btn" aria-live="polite">
            <!-- 🔘 THE BUTTON ELEMENT: Our interactive component -->
            ...
            <span class="btn-text">Confirm action</span>
            <!-- 📝 BUTTON TEXT: The primary button label -->
            <!-- This text will fade out during loading state -->
            
            <span class="loader"></span>
            <!-- 🔄 LOADING SPINNER: Appears during the loading state -->
    ...
    <script>
      /* 🧠 ===== JAVASCRIPT: The Button's Interactive Behavior ===== */
      
      const btn = document.getElementById('action-btn');
      /* 🔘 BUTTON REFERENCE: Gets a handle to the button element */
      /* document.getElementById finds an element with the specific ID */
      /* We'll use this reference to modify the button's state */
      
      const handleClick = () => {
          /* 🎯 CLICK HANDLER: Arrow function defines what happens when button is clicked */
          /* Arrow functions (=>) are a modern, concise way to write functions */
          
          // Constraint: prevent multiple clicks
          if (btn.classList.contains('loading')) return;
          /* 🛡️ GUARD CLAUSE: Prevents function from continuing if already loading */
...
<!-- 🎯 ===== INTERACTIVE BUTTON SUMMARY ===== -->
<!-- 
🔘 COMPONENT ARCHITECTURE:
│
├── 🧠 DESIGN SYSTEM (CSS Variables)
│   ├── 🎨 Color tokens (primary, hover, background, text)
│   ├── 📐 Shape tokens (border-radius, font weight)
│   └── 📦 Physics tokens (shadow effects for elevation)
│
├── 📄 LAYOUT FOUNDATION
│   └── 📊 Viewport-centered grid for perfect positioning
│
├── 🔘 BUTTON DESIGN
│   ├── 📊 Grid stacking technique for content alignment
│   ├── 📏 Comfortable padding and minimum width
│   └── 🕳️ Elevation effects using shadows
│
├── 🔄 STATE SYSTEM
│   ├── 👆 Hover state (color change, slight lift)
│   ├── 👇 Active state (press down, shadow change)
│   └── ⏳ Loading state (persistent press, spinner)
│
└── 🧠 INTERACTION LOGIC
    ├── 🛡️ Guard clause to prevent multiple submissions
    ├── ⏱️ Asynchronous operation simulation
    └── 📢 Success feedback
    
🎯 KEY DESIGN FEATURES:
├── 🎭 Physical metaphor through elevation and movement
├── 👁️ Clear state communication through multiple visual cues
├── 📱 Responsive sizing and centered layout
├── 📢 Accessibility support (semantic HTML, ARIA attributes)
└── 🚫 Double submission prevention (both visual and functional)

This button demonstrates how thoughtful design creates intuitive user experiences
by mimicking physical objects and providing clear feedback at every step! 🔘✨
-->
```
