...
**The "Start Wide" Rule:** It is much easier to tighten a layout that is too loose than to try to make a suffocated layout breathe. Start with exaggerated margins. If it looks empty, tighten slowly until it "clicks." If you have to use a line to separate two sections, you have failed with space. Space *is* the active separator.
