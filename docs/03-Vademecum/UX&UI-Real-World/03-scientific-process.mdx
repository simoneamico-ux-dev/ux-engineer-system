...
**What it does:** It is a universal checklist to find usability holes without having to interview 100 people.

**The Analogy:** Before taking off, a pilot doesn't go by "gut feeling." They have a checklist: "Flaps? Check. Fuel? Check." Heuristics are your pre-flight checklist. They aren't for creating; they are for *not crashing*.

**The 3 Lifesaving Heuristics (out of 10):**
1.  **Visibility of System Status:** The system must always tell you what it is doing (Spinners, Progress Bars, Breadcrumbs). If the user asks "Is it stuck?", you failed.
2.  **Match Between System and Real World:** Use the user's language, not the machine's. (e.g., "Trash" instead of "Directory /dev/null").
3.  **Error Prevention:** A design that prevents mistakes (e.g., a date input that only accepts numbers) is better than a funny error message.
